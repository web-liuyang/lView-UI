<template>
	<view class="vc l-image-box">
		<image :class="classname" :src="src" :mode="mode" :lazy-load="lazyLoad" @error="error" @load="load" @click="$emit('click')" :style="{ width, height, borderRadius: raduis }" />
