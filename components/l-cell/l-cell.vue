<template>
  <view class="l-cell-box" @click="$emit('click',$event)">
    <view class="vc cell-container box">
      <l-image v-if="src" class="img-box" :src="src" width="40rpx" height="40rpx" />
      <view class="vc l-box content-box">
        <view>{{ title }}</view>
        <view>
      ...
      <view class="vc arrow-box" @click.stop="$emit('clickIcon',$event)">
